...
//       setCanScrollPrev(api.canScrollPrev());
//       setCanScrollNext(api.canScrollNext());
//       setSelectedIndex(api.selectedScrollSnap()); // Update the selected index
//     }, []);
...
//           canScrollPrev,
//           canScrollNext,
//           selectedIndex, // Provide selected index in context
//         }}
//       >
//         <div
//           ref={ref}
...
// const CarouselCounter = ({ selected, unSelected }) => {
//   const { api, selectedIndex } = useCarousel();
//   const [totalSlides, setTotalSlides] = React.useState(0);
...
//             index === selectedIndex ? "bg-white w-8" : "bg-gray-400 w-2"
//           )}
//           onClick={() => scrollToIndex(index)}
//         />
//       ))}
